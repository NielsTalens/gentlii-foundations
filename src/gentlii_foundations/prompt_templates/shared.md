...
Write the evidence line as normal paragraph text, not as a bullet list item or numbered list item.
Never put `Evidence:` in a bullet list or numbered list.
Write evidence as `**Evidence:** <...>`.
